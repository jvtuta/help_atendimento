<template>
  <div class="card-body p-4">
    ...
    <div class="row mt-2" v-if="registrado">
      <span class="text-success">Registrado com sucesso! É necessário informar o seu gestor ou administrador do sistema para ser habilitado(a) para uso do sistema</span>
    </div>
