...
1° Instalação automatizada do pacote /teddysun/lamp (opcional caso ja possua o srv configurado); /n
2° Remover o proc do php.ini, após a remoção reiniciar o serviço apache; /n
